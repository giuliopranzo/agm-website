<!--#include virtual="/include/header_custom.asp"-->
<%
set annunci = db.execute("select * from annunci where idannuncio = "&request.querystring("idannuncio")&" ")
if annunci.eof then
	Response.Status="301 Moved Permanently"
	Response.AddHeader "Location","http://"&Request.ServerVariables("HTTP_HOST")&"/posizioni-aperte/"
else
...
<p><a href="/posizioni-aperte/">Torna indietro</a></p>
<% end if %>
<!--#include virtual="/Include/footer_custom.asp"-->