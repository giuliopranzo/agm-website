app.controller('shadow', ['$rootScope', '$scope', '$alert', '$location', '$state', '$filter', 'usersSource', 'usersDataService', 'appHelper', 'applicationGlobals', function ($rootScope, $scope, $alert, $location, $state, $filter, usersSource, usersDataService, appHelper, applicationGlobals) {
