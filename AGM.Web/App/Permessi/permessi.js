app.controller('permessi', ['$rootScope', '$scope', '$alert', '$location', '$state', '$filter', 'usersSource', 'usersDataService', 'appHelper', 'applicationGlobals', 'authenticationContainer', function ($rootScope, $scope, $alert, $location, $state, $filter, usersSource, usersDataService, appHelper, applicationGlobals, authenticationContainer) {
